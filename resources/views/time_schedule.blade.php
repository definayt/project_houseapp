...
<section id="testimonials" class="padd-section ">
  <div class="container" data-aos="fade-up">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-12">
          <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=https://definayasmint.my.id/project_ce/assets/xls/{{ $data_project->rab_file }}' width='100%' height='565px' frameborder='10'> </iframe>
